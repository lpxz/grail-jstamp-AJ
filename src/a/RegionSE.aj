...
public aspect RegionSE {
	...
	pointcut scope():within(Bayes.*) && !within(a.RegionSE);
     pointcut start() : scope()&& call(void  a.RegionSE.strangeStart(..));
     pointcut stop() :scope() &&  call(void  a.RegionSE.strangeStop(..));
     pointcut end():scope() && execution(void Bayes..Bayes.main(..));
